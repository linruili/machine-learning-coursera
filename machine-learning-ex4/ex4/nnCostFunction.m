...
delta3 = a3 - y; %m*10
z2 = [ones(m,1) z2]; %m*26
delta2 = delta3*Theta2.*sigmoidGradient(z2); %m*26
delta2 = delta2(:,2:end); %m*25
Delta1 = Delta1 + delta2'*a1; %25*401
Delta2 = Delta2 + delta3'*a2; %10*26

Theta1_tmp = [zeros(hidden_layer_size,1) Theta1s];
Theta2_tmp = [zeros(num_labels,1) Theta2s];
Theta1_grad = 1/m*Delta1 + lambda/m*Theta1_tmp;
Theta2_grad = 1/m*Delta2 + lambda/m*Theta2_tmp;
